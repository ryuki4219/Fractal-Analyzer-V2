...
フラクタル次元解析とAIを活用した画像解析システム（研究・教育目的）
...
**本サービスを利用することで、[利用規約](TERMS_OF_SERVICE.md)に同意したものとみなされます。**
...
### **法的文書**
- **[📜 利用規約](TERMS_OF_SERVICE.md)** - 必ずお読みください ⚠️
- **[🔒 プライバシーポリシー](PRIVACY_POLICY.md)** - データの取り扱い
- **[⚖️ ライセンス](LICENSE)** - MITライセンス

### **使い方ガイド**
- **[🚀 クイックスタート](QUICK_START.md)** - 5分で始める最速ガイド ⭐ NEW!
- **[📘 完全使用ガイド](USER_GUIDE.md)** - 詳しい使い方マニュアル ⭐ NEW!
- **[🔧 トラブルシューティング](TROUBLESHOOTING.md)** - 問題解決ガイド ⭐ NEW!
- **[🎯 精度検証モードガイド](VALIDATION_MODE_GUIDE.md)** - モデル精度の検証方法
- **[📊 プロジェクト進捗](PROJECT_STATUS.md)** - 完成度と今後のロードマップ
...
### 🔮 推論モード
- **通常予測モード**: 低画質画像だけで高品質FDを予測
- **🎯 精度検証モード (NEW!)**: 高画質ペアと比較して予測精度を詳細に検証
  - 相関係数・MAE・RMSE・R²の自動計算
  - 散布図・誤差分布の可視化
  - 画像ごとの詳細な誤差確認
  - CSV形式での結果エクスポート
...
- **[精度検証モード使い方ガイド](VALIDATION_MODE_GUIDE.md)**: 予測精度の検証方法
- **[プロジェクト進捗レポート](PROJECT_STATUS.md)**: 完成度と今後のロードマップ
